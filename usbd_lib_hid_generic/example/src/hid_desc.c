...
ALIGNED(4) const uint8_t USB_DeviceDescriptor[] = {
	...
	USB_DEVICE_DESCRIPTOR_TYPE,		/* bDescriptorType */
	WBVAL(0x0200),					/* bcdUSB 2.0 */
	0xFF,							/* bDeviceClass */  //vendor-specific : aaa-zzz
	0x00,							/* bDeviceSubClass */
	0x00,							/* bDeviceProtocol */
	USB_MAX_PACKET0,				/* bMaxPacketSize0 */
...
ALIGNED(4) uint8_t USB_FsConfigDescriptor[] = {
 ...
 struct  _CUSTOM_DESCRIPTOR {
  uint8_t  bLength;	/**< Size of the descriptor, in bytes. */
  uint8_t  bDescriptorType;	/**< Type of Custom descriptor. */
  uint8_t  bCountryCode; /**< Country code of the localized device, or zero if universal. */
  uint8_t  bNumDescriptors; /**< Total number of ??? report descriptors for the interface. */
#if 0
  PRE_PACK struct POST_PACK _HID_DESCRIPTOR_LIST {
  uint8_t  bDescriptorType; /**< Type of HID report*/
  uint16_t wDescriptorLength; /**< Length of the associated ?? report descriptor, in bytes. */
  } DescriptorList[1]; /**< Array of one or more descriptors */
#endif
} ;


#define CUSTOM_DESCRIPTOR_TYPE    0

typedef struct _CUSTOM_DESCRIPTOR CUSTOM_DESCRIPTOR;

#define CUSTOM_DESC_SIZE   sizeof(CUSTOM_DESCRIPTOR)



#define CUSTOM_SUBCLASS_NONE               0x00
#define CUSTOM_PROTOCOL_NONE               0x00
...
//		CUSTOM_DESC_SIZE              +
	...
	0x00,							/* bAlternateSetting */
	0x02,							/* bNumEndpoints */
	USB_DEVICE_CLASS_VENDOR_SPECIFIC,	/* bInterfaceClass */    //aaa-zzz
	CUSTOM_SUBCLASS_NONE,				/* bInterfaceSubClass */
	CUSTOM_PROTOCOL_NONE,				/* bInterfaceProtocol */
//	0x04,							/* iInterface */
	0x00,							/* iInterface */
#if 0
	/* HID Class Descriptor */
	/* HID_DESC_OFFSET = 0x0012 */
	CUSTOM_DESC_SIZE,					/* bLength */
	CUSTOM_DESCRIPTOR_TYPE,		/* bDescriptorType */
	0x00,							/* bCountryCode */
	0x01,							/* bNumDescriptors */
//#if 0
	HID_REPORT_DESCRIPTOR_TYPE,		/* bDescriptorType */
	...
	USB_ENDPOINT_DESC_SIZE,			/* bLength */
	USB_ENDPOINT_DESCRIPTOR_TYPE,	/* bDescriptorType */
	CUSTOM_EP_OUT,						/* bEndpointAddress */
	USB_ENDPOINT_TYPE_BULK,	/* bmAttributes */
	WBVAL(0x0008),					/* wMaxPacketSize */
	0x20,							/* bInterval: 16ms */
	/* Terminator */
